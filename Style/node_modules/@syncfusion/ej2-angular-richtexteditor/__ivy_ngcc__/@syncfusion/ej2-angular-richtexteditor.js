...
RichTextEditorComponent.ɵfac = function RichTextEditorComponent_Factory(t) { return new (t || RichTextEditorComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector)); };
RichTextEditorComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: RichTextEditorComponent, selectors: [["ejs-richtexteditor"]], contentQueries: function RichTextEditorComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, _c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.valueTemplate = _t.first);
    } }, inputs: { backgroundColor: "backgroundColor", cssClass: "cssClass", editorMode: "editorMode", enableAutoUrl: "enableAutoUrl", enableHtmlEncode: "enableHtmlEncode", enableHtmlSanitizer: "enableHtmlSanitizer", enablePersistence: "enablePersistence", enableResize: "enableResize", enableRtl: "enableRtl", enableTabKey: "enableTabKey", enableXhtml: "enableXhtml", enabled: "enabled", floatingToolbarOffset: "floatingToolbarOffset", fontColor: "fontColor", fontFamily: "fontFamily", fontSize: "fontSize", format: "format", formatter: "formatter", height: "height", htmlAttributes: "htmlAttributes", iframeSettings: "iframeSettings", inlineMode: "inlineMode", insertImageSettings: "insertImageSettings", keyConfig: "keyConfig", locale: "locale", maxLength: "maxLength", pasteCleanupSettings: "pasteCleanupSettings", placeholder: "placeholder", quickToolbarSettings: "quickToolbarSettings", readonly: "readonly", saveInterval: "saveInterval", showCharCount: "showCharCount", tableSettings: "tableSettings", toolbarSettings: "toolbarSettings", undoRedoSteps: "undoRedoSteps", undoRedoTimer: "undoRedoTimer", value: "value", valueTemplate: "valueTemplate", width: "width" }, outputs: { actionBegin: "actionBegin", actionComplete: "actionComplete", afterImageDelete: "afterImageDelete", beforeDialogOpen: "beforeDialogOpen", beforeQuickToolbarOpen: "beforeQuickToolbarOpen", beforeSanitizeHtml: "beforeSanitizeHtml", blur: "blur", change: "change", created: "created", destroyed: "destroyed", dialogClose: "dialogClose", dialogOpen: "dialogOpen", focus: "focus", imageRemoving: "imageRemoving", imageSelected: "imageSelected", imageUploadFailed: "imageUploadFailed", imageUploadSuccess: "imageUploadSuccess", imageUploading: "imageUploading", quickToolbarClose: "quickToolbarClose", quickToolbarOpen: "quickToolbarOpen", resizeStart: "resizeStart", resizeStop: "resizeStop", resizing: "resizing", toolbarClick: "toolbarClick", toolbarStatusUpdate: "toolbarStatusUpdate", valueChange: "valueChange" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => RichTextEditorComponent_1),
                multi: true
            }
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function RichTextEditorComponent_Template(rf, ctx) { }, encapsulation: 2, changeDetection: 0 });
/**
 * @nocollapse
 */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RichTextEditorComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc0.Injector }]; }, { valueTemplate: [{
            type: ContentChild,
            args: ['valueTemplate']
        }] }); })();
...
RichTextEditorModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: RichTextEditorModule });
RichTextEditorModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function RichTextEditorModule_Factory(t) { return new (t || RichTextEditorModule)(); }, imports: [[CommonModule]] });
/**
 * @nocollapse
 */
RichTextEditorModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RichTextEditorModule, { declarations: function () { return [RichTextEditorComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [RichTextEditorComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RichTextEditorModule, [{
        type: NgModule,
        args: [{
...
RichTextEditorAllModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: RichTextEditorAllModule });
RichTextEditorAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function RichTextEditorAllModule_Factory(t) { return new (t || RichTextEditorAllModule)(); }, providers: [
        ToolbarService,
        LinkService,
        ImageService,
        CountService,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RichTextEditorAllModule, { imports: function () { return [CommonModule,
        RichTextEditorModule]; }, exports: function () { return [RichTextEditorModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RichTextEditorAllModule, [{
        type: NgModule,
        args: [{
                imports: [CommonModule, RichTextEditorModule],
                exports: [
